...
=== ending_body ===
    {GabeAlive == true:
        The detective leans in. “I’m going to ask you a few questions, alright buddy?”
        + {not ChoomChoomAlive} [Explain what happened to ChoomChoom]
                {GabeState >= 0:
        ...
        + {not BobAlive} [Explain what happened to Bob]
                {GabeState >= 0:
                ...
                ->ending_body
        + {not PerryAlive} [Explain what happened to Perry]
                {GabeState >= 0:
    ...
    {BobAlive == true:
        ...
        + {GabeAlive == false} [Explain what happened to Gabe]
                ...
                ->ending_body
        + {ChoomChoomAlive == false} [Explain what happened to ChoomChoom]
    ...
    {PerryAlive == true:
        + {GabeAlive == false} [Explain what happened to Gabe]
                {PerryState >= 0:
                    Perry says something good about Jimmy in regards to Gabe
                - else:
                    Perry says something bad about Jimmy in regards to Gabe
                }
                ->ending_body
        + {BobAlive == false} [Explain what happened to Bob]
                {PerryState >= 0:
                    Perry says something good about Jimmy in regards to Bob
                - else:
                    Perry says something bad about Jimmy in regards to Bob
                }
                ->ending_body
        + {ChoomChoomAlive == false} [Explain what happened to ChoomChoom]
                {PerryState >= 0:
                    Perry says something good about Jimmy in regards to ChoomChoom
                - else:
                    Perry says something bad about Jimmy in regards to ChoomChoom
                }
                ->ending_body
    }
-
...
=== ending_description_gabe(->ret) ===
{currentProgression == ending && storyletProgression == gabeS:
...
=== jimmyEnd_body ===
    ...
    {jimmySuspicious} [The campers.]
            ...
            {PerryAlive == false} [It's the end of the road for you]
