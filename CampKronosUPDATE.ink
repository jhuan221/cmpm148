LIST progression = intro, dinner, hike, gabe, bob, choomchoom, perry, ending, jimmyEnd
VAR GabeAlive = true
VAR BobAlive = true
...
VAR GabeState = 0
VAR BobState = 0
VAR ChoomChoomState = 0
VAR PerryState = 0
VAR currentProgression = intro

LIST storyletProgression = beginning, middle, end, gabeS, bobS, choomchoomS, perryS
...
<- ending_description_gabe(ret)
<- ending_description_bob(ret)
<- ending_description_choomchoom(ret)
<- ending_description_perry(ret)
<- jimmyEnd_description(ret)
...
“ I guess so too,” said ChoomChoom.
  Both of you decided to ask Perry.
        ~currentProgression = perry
...
* [Bribe Perry]
    ...
    ** [Don’t Listen To the Voice]
        Jimmy calmed himself down and decided to not listen to the voice.
...
= endOfBob
~ PerryState++
    ~ currentProgression = jimmyEnd
    ~ storyletProgression = gabeS
-
->->

=== ending_description_gabe(->ret) ===
{GabeAlive == false: 
    ~ storyletProgression = bobS
}
{currentProgression == ending && storyletProgression == gabeS && GabeAlive:
        The police interrogate Gabe
        -> ending_body_gabe ->
    -> ret
}
->DONE
=== ending_description_bob(->ret) ===
{BobAlive == false: 
    ~ storyletProgression = choomchoomS
}
{currentProgression == ending && storyletProgression == bobS && BobAlive:
        The police interrogate Bob
        -> ending_body_bob ->
    -> ret
}
->DONE
=== ending_description_choomchoom(->ret) ===
{ChoomChoomAlive == false: 
    ~ storyletProgression = perryS
}
{currentProgression == ending && storyletProgression == choomchoomS && ChoomChoomAlive:
        The police interrogate ChoomChoom
        -> ending_body_choomchoom ->
    -> ret
}
->DONE
=== ending_description_perry(->ret) ===
...
{currentProgression == ending && storyletProgression == perryS && PerryAlive:
        The police interrogate Perry
        -> ending_body_perry ->
    -> ret
}
->DONE
...
=== ending_body_gabe ===
        The detective leans in. “I’m going to ask you a few questions, alright buddy?” ->questions
= questions
        
        {ChoomChoomAlive == false:
            * [Explain what happened to ChoomChoom]
                ->gabeAboutChoomChoom
        }
        {BobAlive == false: 
            * [Explain what happened to Bob]
                ->gabeAboutBob
        }
        {PerryAlive == false: 
            * [Explain what happened to Perry]
                ->gabeAboutPerry
        }
        + [Move on to next interrogation]
            ->toBob
= gabeAboutChoomChoom
                    {GabeState >= 0:
                        “Can you tell me what happened to ChoomChoom? I heard there was a commotion around the lake?” 
                        “We were hanging out by the lake. Me and ChoomChoom were skipping rocks for a while till we found this really big rock.” 
            
                        Gabe uses his hand to draw an imaginary boulder. “Choomchoom tripped while carrying the rock and broke his arm. Jimmy went to go help and took him back to the camp to get checked out. I wanted to stay at the lake, so I stayed with the other group.”  
            
                        “The group with Alice?”, asked the detective. “Yup”, responded Gabe.
                        ->questions
        
                    - else:
                        “We were hanging out by the lake. Me and ChoomChoom were skipping rocks for a while till we found this really big rock.” 
                        “ChoomChoom was trying to lift this large rock and ended up tripping.Broke his arm pretty much”, Gabe winced, recalling the detail. 
        
                        “It was kinda dangerous but no one stopped him.”
        
                        Gabe hesitates for a second and continues: “Jimmy seemed kinda annoyed but brought him back to camp. He seemed irritated during the whole trip.” 
                        ->questions
    
                    }
= gabeAboutBob
                {GabeState >= 0:
                    “The group went back to camp after hanging out at the lake. I wanted to be at the lake longer so I stayed with Alice,” Gabe exclaims. 
    
                    “Bob was looking a bit sad about something, Jimmy tried cheering him up a bit by talking to him while we were playing in the water.” “He might have wandered off like did,” said Gabe. 
    
                    He looked down on the floor, kicking his feet: “I kinda, might have ran off cuz I got distracted on the way to the lake. I heard Jimmy ran all over to find me.” 
                    ->questions
    
                - else:
                    “The group went back to camp after hanging out at the lake. I wanted to be at the lake longer so I stayed with Alice,” Gabe exclaims. 
    
                    “I heard from my friends that Bob went missing on their way back. Bob isn’t a guy who just wanders, like me. Kinda strange that he just went missing.”
                    ->questions
    
                }
= gabeAboutPerry
                {GabeState >= 0:
                    “Perry is a bit of a demanding guy. He told me to find the plushie that he lost while we were hiking our way to the hike. I got kinda lost and Jimmy found me, reunited me back with the homies.”
    
                    The detective scribbles notes down.
    
                    Gabe sighed, “He probably asked Jimmy to help him find it and wandered off to go play.  Maybe even before the earthquake, knowing his luck. Also he was the one who egged everyone to start chanting for ChoomChoom to lift the rock. ” Gabe shakes his head in annoyance. 
                    ->questions
                    {brokenArm == true:
                         “Plus he had to deal with ChoomChoom and helping to make sure he was alright too. He just broke his arm and Jimmy rushed to help him,” noted Gabe, crossing his arms.
                        ->questions
                    }
                - else:
                        “Jimmy was already a bit on edge with Perry and I since he lost the mascot plush and I went to go find the plushie without lettin him know.” 
        
                        Gabe looks down, “It was a mistake for not lettin him know, I know. But he didn’t drop it that far from where we walked, so I thought it would be quick. Jimmy was a bit annoyed that we just took off.”   
...
=== ending_body_bob ===
        The detective approaches Bob to ask a few questions.

“I’m going to ask you a few questions. Is that okay with you, buddy?”

“Y-yes,” Bob stammers.” ->questions
= questions
        ...
        {GabeAlive == false: 
            * [Explain what happened to Gabe]
                ->bobAboutGabe
        }
        + [Move on to next interrogation]
            ~currentProgression = jimmyEnd
            ~storyletProgression = ChoomChoomState
            ->->
= bobAboutChoomChoom
                    {BobState < 0:
                        “Can you tell me what happened to ChoomChoom? I heard there was a commotion around the lake?” 
                        {brokenArm == true:
                            “Well, I’m not really sure. I went to look at the zipline after ChoomChoom broke his arm. Jimmy came to look for me, but when we came back together, ChoomChoom was gone.”

                            “Anything off about Jimmy during the hike?”

                            “He seemed a bit irritated throughout the night and when ChoomChoom picked up the rock, he never stopped him. It looked very dangerous.”

                        -else:
                            “Well, I’m not really sure. I went to look at the zipline after ChoomChoom tried to throw a rock into the lake. Jimmy came to look for me, but when we came back together, ChoomChoom was gone.”

                            The detective nods and thanks Bob.

                        }
                        ->questions
        
                    - else:
                        “Can you tell me what happened to ChoomChoom?”
                        {brokenArm == true:
                            “I’m not really sure. I went to look at the zipline after ChoomChoom broke his arm by tripping over a rock. That was really funny. Jimmy warned him that it was dangerous, but he was stubborn and didn’t listen”

                        -else:
                            “I’m not really sure. I went to look at the zipline after Jimmy stopped ChoomChoom from throwing a rock into the lake. ChoomChoom seemed really annoyed at Jimmy afterwards, but that’s all I saw.”
...
= bobAboutGabe
                {BobState >= 0:
                    ...
                    “I don’t really know. After Jimmy finished telling us a story about Bigfoot, there was a loud sound. I got really scared and closed my eyes, but when I opened them again, he was missing.” Bob responds.

                    The detective nods his head and jots down some notes. “Was there anything off with Jimmy before the incident?”

                    Bob scratches his head and replies. “No, he was perfectly normal.”
                ...
                - else:
                    ...
                    Bob looks down at his feet and fidgets. “Jimmy was telling us a story about Bigfoot after ChoomChoom called Gabe stupid for not knowing who Bigfoot was.”

                    Bob looks at the detective and adds on, “He seemed really irritated at Gabe for some reason.”

                    The detective jots down some notes. “What happened after the story?”

                    “There was a strange sound that sounded like a growl. I got really scared by it and closed my eyes tightly, but when I opened my eyes again, Gabe was gone. When I looked at Jimmy again, he seemed less annoyed and had us follow footprints to find Bigfoot even though Gabe was missing.”
...
->->
=== ending_body_choomchoom ===
    "Alright ChoomChoom, you're up. Tell me what you know."
    * [ChoomChoom explains what he knows]
        {ChoomChoomState >= 0:
            "Jimmy was so helpful and caring during our hike, I’m sure he wouldn’t do any bad things."
                ->toPerry
        - else:
            {PerryAlive == true:
                I felt something was wrong with Jimmy from the beginning of the Hike. And as the hike went on, more and more weird stuff started to happen.  Children started to disappear and I decided to watch Jimmy from afar.  When Jimmy started questioning Perry about Bob’s disappearance, I decided to follow him.  After some time, I saw Jimmy eating Perry.
                    ->toPerry
            -else:
                I felt something was wrong with Jimmy from the beginning of the Hike. And as the hike went on, more and more weird stuff started to happen.  Children started to disappear and I decided to watch Jimmy from afar.  While I dont have any proof, I’m confident Jimmy did something bad.
                    ->toPerry
...
->->
=== ending_body_perry ===
Perry enters the room with the detective. As Perry sits down in the chair across from him, the detective begins his questioning.

“Alrighty, your name is… Perry, right?”

“Y-yes sir.”

“Ok. I’m going to ask you about the other campers, is that alright?”

“Yes.”

{PerryState >= 0:
    Jimmy is a wonderful guy. To me he seemed to always be helpful and supportive, so I see no way that he could do any harm.
    ->endCamperInter
-else:
    Jimmy was a jerk the whole night. I don't know if it was just to me but he was always so aggressive and never seemed friendly to me.
    ->endCamperInter
}
= endCamperInter
    ~currentProgression = jimmyEnd
...
=== jimmyEnd_body ===
    “Bring him in.” The door clicks, in comes Jimmy and Alice as they sit down in front of the detective. 
    {PerryAlive == false:
        “Can I give my testimony after, I … I want some privacy”, said Alice. Fidgeting with her hair, she puts some distance between herself and Jimmy. The awkward tension was quite obvious to the detective. 

        “Of course.”, the detective gestures towards the door. “You may leave.”

    - else:
        Alice pulls the chair out for Jimmy. “He’s a little out of it,” Alice responds to the detective looking at the pair. 

        The detective turns to Jimmy. “Of course, no one knows when an earthquake will strike, let alone a tree to strike you in the head. Did you get checked out by any medic?” 

        “Yeah, might be a concussion”, Jimmy answered wearily.
    }
    “Well I’m not gonna waste much time here.” The detective shuffles some papers and folds his hand.
    VAR missingNum = 0
    VAR unfavNum = 0
    {GabeAlive == false:
        ~ missingNum++
    ...
    VAR jimmySuspicious = false
    { missingNum >= 2 || unfavNum >= 2:
        ~ jimmySuspicious = true
    }
    {jimmySuspicious == true: 
        * [The campers.]
            ->first_chunk
...
=first_chunk
            “The kids that went missing, do you know anything about them?”

            Jimmy makes direct eye contact with detectives, “The campers… Oh my god. They  went missing? How? Why? … Did they not get found after the earthquake?”.

            The detective responds, “ Jimmy, those kids went missing long before the earthquake hit.”

            An image of bewilderment came across Jimmy’s face, he pauses to think, to listen.
            {PerryAlive == false: 
                * [It's the end of the road for you]
                    ->second_chunk
            - else:
                Continuing to question what was happening in his confused state, Alice ask the investigator if they could take pause and have some time for Jimmy to think. 

                “He’s still trying to process everything, plus he’s still healing from his head injury. Can we just have five minutes for him to rest a bit?” 

                The detective flickered his eyes towards his watch and back at Jimmy sitting in a slight daze mood. 

                “Five minutes and we continue.” The door clicks as he leaves.
                * [What are we to do Jimmy?]
                    ->third_chunk

            }
=second_chunk
                    “Those campers were under your supervision, you must have some id-”. The detective was interrupted by the abrupt giggles coming from Jimmy. 
                    
                    The detective’s expression soured, “Do you think this is funny?”. 
                    ** [Stop this. Give me my body back.]
                        Jimmy continues to giggle hysterically, wiping the tears from his eyes. He finally answers back, “Oh, I know where they went.” He points to himself,  “They’re always with me.” Clearly, that line cracked him up as he let out a howling laugh. As abrupt as his laughter started, Jimmy stopped laughing and passed out, his body slumped onto the table.
                        
                        *** [It was always your Jimmy. Always.]
                            The detective was baffled at what occurred, and just noticed his phone had been ringing for a while.  
                            “Detective Buster, we’ve found some body parts … They look like they’ve been torn into shred.”
                            ->final_flashBack
=third_chunk
    Jimmy flinches, and Alice asks if he’s alright. 
 
  “I’m ok… Could you leave for a sec? I just want some time for myself. Sorry Alice.”
  
    Alice nods and pats him on the back. The door clicks again.
    
    * [Are you going to confess?]
        Jimmy stares at the empty seat in front of him. Suddenly, he slams his hand on the table. 
        
        Realizing the commotion he’s making, he tries to calm himself, taking in deep breaths.
        
        * * [There's really no point. They're gonna find the remnants of the bodies anyways.]
             His body slouches. Closing his eyes, the memory came flooding back in.
             ->final_flashBack

=fourth_chunk
     “Well from what I heard, it seems like you’ve had a lot to handle with the campers you had to deal with. Just give me a general account of what happened during the hike and you’ll be off.” 
     {PerryAlive == false:
         “I’ll try my best.” Jimmy gave his accounts, the detective nodding and scribbling the general details, how they had dinner together and we went on the nightly hike to explore the lake. 

        “That’s all I recall for the most part. I’m sorry that’s all I can recall now.”

        “It’s enough for now. We will let you know if we need you again.” The detective gestures nonchalantly towards the door, “You may leave.” 

        The detective’s phone rings as the door clicks behind Jimmy. 

        He steps outside looking at the mountains in the distance. The wrecked left behind, the jagged pieces buried deep within the outline of what the mountains once were. 

        Jimmy closes his eyes for a brief moment, and the memory floods in.
        
        * [This isn't over just yet Jimmy]
            ->final_flashBack
     -else:
        Alice chimes in as Jimmy recalls the story, helping piece a more detailed account of what occurred that night. The detective jots the details and assures the counselors that they’ll find the missing kids soon. 

        “We’ll let you know first if we find the kids alright? Go get some rest.” 

        Alice and Jimmy step outside. Alice looks over at him to check how he’s feeling. “
        
        “Don’t blame yourself. They’re gonna be fine.”
        
        Jimmy looks at Alice in the eye, he looked like he wanted to responded by but could. His gaze shifted to the floor, looking defeated.
        
        * [But it was you Jimmy]
            ->final_flashBack
...
=== final_flashBack ===
        Jimmy flashes back to an argument between himself and himself from a past life.
